...
class __TwigTemplate_4f4978316c27ccfbeb1e3f8671900700374ff0a6098bcb14efc9901b02d1a2ed extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container\">
    ...
    ";
        ...
        echo "\"
            data-widget-counter=\"";
        // line 24
        echo twig_escape_filter($this->env, twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 24, $this->source); })()), "image", [], "any", false, false, false, 24)), "html", null, true);
        echo "\">
...
";
    ...
    {
        return array (  106 => 35,  92 => 24,  88 => 23,  84 => 21,  78 => 19,  73 => 17,  66 => 13,  61 => 10,  59 => 9,  53 => 6,  48 => 4,  43 => 1,);
    }
...
<div class=\"container\">
    ...
    {% if category is defined %}
        ...
        <div class=\"border-1\">
            <span>Image actuelle</span>
            <img class=\"img-thumbnail w-25\" src=\"{{ asset('images/category/' ~ category.image) }}\">
        </div>

        <label>Changer l'image si l'actuelle ne convient pas... </label>
        {{ form_row(form.image, {'required': false}) }}
    {% else %}
        {{ form_row(form.image, {'required': true}) }}
    {% endif %}
...
", "category/_form.html.twig", "/Users/coco/Desktop/Projet DEV/horizonImmersion/templates/category/_form.html.twig");
    }
}
